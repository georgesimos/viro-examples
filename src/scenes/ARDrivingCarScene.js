...
export default class ARDrivingCarScene extends Component {
  ...
  render() {
    ...
    let environmentLightSource = require("../assets/images/driving_car/learner_park_1k.hdr");
    ...
    return (
      ...
      >
        ...
        <ViroSound
          source={require("../assets/images/driving_car/car_ambient.mp3")}
          paused={!this.state.isReady}
          loop={true}
        />
        <ViroSound
          source={require("../assets/images/driving_car/car_drive.mp3")}
          paused={shouldPauseAccelSound}
          loop={true}
        />
        <ViroSound
          source={require("../assets/images/driving_car/car_idle.mp3")}
          paused={shouldPauseIdleSound}
          loop={true}
  ...
  _getScanningQuads() {
    ...
    return (
      <ViroNode transformBehaviors={"billboardY"} position={this.state.planeReticleLocation} scale={[0.5, 0.5, 0.5]}>
        <ViroImage
          rotation={[-90, 0, 0]}
          visible={this.state.foundPlane}
          source={require("../assets/images/driving_car/tracking_diffuse_2.png")}
        />
        <ViroImage
          rotation={[-90, 0, 0]}
          visible={!this.state.foundPlane}
          source={require("../assets/images/driving_car/tracking_diffuse.png")}
        />
      </ViroNode>
    );
  }
      ...
      <ViroNode position={position} rotation={this.state.modelWorldRotation} transformBehaviors={transformBehaviors}>
        ...
        >
          ...
          <Viro3DObject
            ...
            position={[0, 0, 0]}
            source={require("../assets/images/driving_car/car_body.vrx")}
            type="VRX"
            resources={[
              require("../assets/images/driving_car/bumblebee_Base_Color.png"),
              require("../assets/images/driving_car/bumblebee_Metallic.jpg"),
              require("../assets/images/driving_car/bumblebee_Roughness.jpg"),
              require("../assets/images/driving_car/bumblebee_Normal_OpenGL.jpg"),
            ]}
          />
          ...
          <ViroNode
            ref={(wheel) => {
              this.frontLeftWheelContainer = wheel;
            }}
          ...
          >
            ...
            >
              <Viro3DObject
                source={require("../assets/images/driving_car/car_wheels.vrx")}
                type="VRX"
                rotation={[0, 180, 0]} // the left wheels need to be rotated 180
                resources={[
                  require("../assets/images/driving_car/wheels_Base_Color.jpg"),
                  require("../assets/images/driving_car/wheels_Metallic.jpg"),
                  require("../assets/images/driving_car/wheels_Roughness.jpg"),
                  require("../assets/images/driving_car/wheels_Normal_OpenGL.jpg"),
                ]}
              />
            </ViroNode>
          </ViroNode>
          ...
          <ViroNode
            ref={(wheel) => {
              this.frontRightWheelContainer = wheel;
            }}
            position={[0.61, 0.363, -1.336]}
          >
            <ViroNode
  ...
  _computeNewLocation() {
    ...
    if ((pressedDirectionButtons & 5) > 0) {
      ...
      if ((pressedDirectionButtons & 1) > 0) {
        // Left
        additionalRotation =
          -(((currentVelocity * (intervalTime / 1000)) / distanceToFullTurn) * turnRatio) * 2 * Math.PI; // radians
...
ViroMaterials.createMaterials({
  dropShadow: {
    diffuseTexture: require("../assets/images/driving_car/car_shadow.png"),
