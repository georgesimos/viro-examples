...
export default class ARDrivingCar extends Component {
  ...
  getViroARView() {
    ...
    let viroAppProps = {
      direction:
        (this.state.left ? 1 : 0) + (this.state.up ? 2 : 0) + (this.state.right ? 4 : 0) + (this.state.down ? 8 : 0),
    ...
    return (
      <ViroARSceneNavigator
        ...
        initialScene={{
          scene: require("../scenes/ARDrivingCarScene.js"),
          passProps: {
  ...
  getCarControls() {
    return (
      <Animated.View
        style={{ position: "absolute", width: "100%", height: "100%", opacity: this.state.carControlsOpacity }}
      >
      ...
      <View style={styles.drivingButtonsContainer}>
        <View style={styles.drivingButton}>
          <Image
            ...
            source={require("../assets/images/driving_car/pedal_reverse.png")}
          />
          <Image
            style={styles.pedalImage}
            opacity={!this.state.down ? 0 : 1}
            source={require("../assets/images/driving_car/pedal_reverse_press.png")}
          />
          <View
        ...
        <View style={styles.drivingButton}>
          <Image
            ...
            source={require("../assets/images/driving_car/pedal_accel.png")}
          />
          <Image
            style={styles.pedalImage}
            opacity={!this.state.up ? 0 : 1}
            source={require("../assets/images/driving_car/pedal_accel_press.png")}
          />
          <View
            style={styles.pedalTouchArea}
  ...
  getJoystick() {
    ...
    return (
      <View style={styles.joystickContainer}>
        <Image style={joystickButtonStyle} source={require("../assets/images/driving_car/steering_wheel.png")} />
        <View
          style={styles.joystickTouchArea}
          onTouchStart={this.joystickStart}
          onTouchMove={this.joystickMove}
          onTouchEnd={this.joystickEnd}
        />
      </View>
    );
  }
  ...
  getResetButton() {
    return (
      <TouchableOpacity style={styles.resetButton} onPress={this.resetCar} activeOpacity={0.6}>
        <Image style={styles.resetImage} source={require("../assets/images/driving_car/icon_refresh.png")} />
      </TouchableOpacity>
    );
  }
  ...
  joystickMove(evt) {
    ...
    this.setState({
      touchLocation:
        "" +
        evt.nativeEvent.locationX.toFixed(2) +
        ", " +
        evt.nativeEvent.locationY.toFixed(2) +
        ", " +
        evt.nativeEvent.pageX.toFixed(2) +
        ", " +
        evt.nativeEvent.pageY.toFixed(2),
    });
  }
